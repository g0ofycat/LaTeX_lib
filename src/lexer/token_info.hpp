...
enum class TokenType {
    NUMBER, COMMAND, BRACE_OPEN, BRACE_CLOSE, BRACKET_OPEN, BRACKET_CLOSE, PLUS, MINUS, STAR, SLASH, IDENTIFIER, SUBSCRIPT, SUPERSCRIPT, DOLLAR, ALIGNMENT, PUNCTUATION, WHITESPACE, END_OF_FILE, INVALID, UNKNOWN
};
